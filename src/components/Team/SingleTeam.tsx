...
const SingleTeam = ({ team, onOpen }: { team: TeamType; onOpen?: () => void }) => {
  const { image, name, designation, googleScholarLink, twitterLink, linkedinLink } =
    team;
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
      <div className="group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none">
        <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]" onClick={onOpen} role={onOpen ? "button" : undefined} aria-label={onOpen ? `Open profile of ${name}` : undefined}>
          <Image src={image} alt={name} className="h-full w-full rounded-full object-cover" width={120} height={120} />
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-5">
            ...
            >
              <Image
                src="/images/logo/google_scholar.svg"
                alt="Google Scholar"
                width={18}
                height={18}
                className="w-[18px] h-[18px] opacity-60 hover:opacity-100 transition-opacity duration-300"
              />
            </Link>
            <Link
              aria-label="social link"
